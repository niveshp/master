...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    // ReSharper restore InconsistentNaming
    {
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitTestWithRecordsetUsingStar");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitTestWithRecordsetWithIndex");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitTestWithRecordsetsWithNoIndexes");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitTestAppendingToDifferentRecordsets");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitTestWithScalar");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitAllDifferentTypesOfSplits");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "Integration Test Resources/DataSplitVariableInSource");
